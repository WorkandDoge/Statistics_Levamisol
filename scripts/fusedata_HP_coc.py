...
output_file = '/Users/carinaobermuller/Documents/Statistics_Levamisol/output_files/fuseddata_HP_COC_Total.csv'
...
selected_column = pd.read_csv(master_file_path, usecols=['HP_COC_Total'])
...
merged_data.insert(0, 'HP_COC_Total', selected_column['HP_COC_Total'])
...
merged_data = merged_data.dropna(subset=['HP_COC_Total'])
