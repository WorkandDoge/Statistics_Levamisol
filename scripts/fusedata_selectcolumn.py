...
output_file = '/Users/carinaobermuller/Documents/Statistics_Levamisol/data/fuseddata_selectedcolumn.csv'
...
for file_name in file_list:
    ...
    if file_name in ['fuseddata.csv', 'Value_Labels.csv', 'Variable_Definitions.csv', 'Masterfile_Cross_Sectional.csv']:
        continue
