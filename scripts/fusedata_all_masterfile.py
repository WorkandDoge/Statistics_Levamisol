...
output_file = '/Users/carinaobermuller/Documents/Statistics_Levamisol/output_files/fuseddata_all_masterfile.csv'
...
for file_name in file_list:
    ...
    if file_name in ['fusedata_all_masterfile.csv', 'fuseddata_Group_High_Low_Lev_COC_Ratio.csv', 'Value_Labels.csv', 'Variable_Definitions.csv']:
        continue
